...
export default function HomePage() {
  ...
  return (
    <div
      className="home-container flex flex-col w-full min-h-screen overflow-hidden relative z-0"
      ...
      <div className="hero flex flex-col min-h-screen">
        <div className="flex flex-col items-center justify-center h-screen z-20">
          ...
          <div className="buttons flex flex-wrap items-center justify-center gap-3 md:gap-10">
            ...
            <a
              href="https://github.com/efredriksen05"
              target="_blank"
              rel="noopener noreferrer"
              className="links"
            >
            ...
            <a
              href="/hero/Emma_Fredriksen_CV.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="links"
            >
